...
namespace HangFire.Application.FaceImageApi.Impl
{
    ...
    /// </summary>
    public class FaceImageApiService : HangfireApplicationServiceBase, IFaceImageApiService
    {
        private readonly IFaceImageApiRepository _faceimageapiRepository;
        private readonly IFaceImageApiCacheSevice _faceimageapiCacheService;

        public FaceImageApiService(IFaceImageApiRepository faceimageapiRepository,
                                    IFaceImageApiCacheSevice faceimageapiCacheService)
        {
            _faceimageapiRepository = faceimageapiRepository;
            _faceimageapiCacheService = faceimageapiCacheService;
        }
        ...
        {
            return await _faceimageapiCacheService.GetFaceImageTokenCacheAsync(TokenUrl , async() =>
            {
