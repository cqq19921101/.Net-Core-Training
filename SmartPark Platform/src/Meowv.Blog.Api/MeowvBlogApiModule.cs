...
using SmartPark.EntityFrameworkCore;
...
namespace Meowv.Blog.Api
{
    [DependsOn(
        ...
        typeof(SmartParkFrameworkCoreModule)
    )]
    public class MeowvBlogApiModule : AbpModule
    {
        ...
        /// <summary>
        /// Build OnApplicationInitialzation  Include : Healthcheck api,
        /// </summary>
